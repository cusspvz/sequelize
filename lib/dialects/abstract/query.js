...
class AbstractQuery {
  ...
  /**
   * Execute the passed sql query and return data as a stream.
   *
   * Examples:
   *
   *     query.runStream('SELECT 1').pipe(outputStream)
   *
   * @param {String} sql - The SQL query which should be executed.
   * @private
   */
  runStream() {
    throw new Error('This dialect does not support query streams!');
  }
